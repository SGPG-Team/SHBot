...
class BotPing(commands.Cog):
	...
	async def main(self, msg):
		...
		if msg.content.strip() == ("<@1196573758757028021>"):
			embed = discord.Embed(
				description=f"Привет! Я многофункциональный дискорд бот, созданный <@685091615991136290> и <@567014541507035148> и предназначенный чисто для этого сервера Anthill. Моя главная цель — помочь вам в изучении команд, датапаков и ресурспаков, но я также имею и другие интересные функции. Используйте команду </help:1270684227419246623>, чтобы узнать больше о моих функциях.", 
				color=no_color)
